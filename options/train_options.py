...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--disc_iters', type=int, default=1, help='number of D updates')
        ...
        self.parser.add_argument('--lambda_GAN2', type=float, default=0.0, help='weight on D2 loss, D(G(A, ))')
        self.parser.add_argument('--lambda_z', type=float, default=0.0, help='weight for ||predict_z - random_z||')
        self.parser.add_argument('--use_same_D', action='store_true', help='if use the same D')
        self.isTrain = True
