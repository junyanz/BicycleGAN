...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_GAN2', type=float, default=0.0, help='weight on D2 loss, D(G(A, random_z))')
        self.parser.add_argument('--lambda_z', type=float, default=0.0, help='weight for ||E(G(random_z)) - random_z||')
